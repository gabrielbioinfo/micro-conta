...
describe('Portador', () => {
  it('should be able to create a Portador', async () => {
    let portador = new Portador(new CPF('821.484.270-08'), 'Some Name');
    ...
    expect(() => {
      ...
      new Portador(new CPF('821.484.270-08'), 'Some Name', `${uuidForTest}XXX`);
